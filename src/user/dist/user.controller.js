...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.register = function (userInfo) {
        return __awaiter(this, void 0, Promise, function () {
            var user, newUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.UserService.findByName(userInfo.username)];
                    case 1:
                        user = _a.sent();
                        if (user)
                            return [2 /*return*/, false];
                        newUser = __assign({}, userInfo);
                        return [4 /*yield*/, this.UserService.register(newUser)];
                    case 2:
                        user = _a.sent();
